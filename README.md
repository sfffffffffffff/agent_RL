...
```bash
conda create -p /mnt/shared-storage-user/evobox-share/songfan/conda_envs/verl-agent-webshop python==3.10 -y
conda activate /mnt/shared-storage-user/evobox-share/songfan/conda_envs/verl-agent-webshop
```

Install WebShop
```bash
cd /mnt/shared-storage-user/evobox-share/songfan/project/verl-agent-master/agent_system/environments/env_package/webshop/webshop
./setup.sh -d all
```
...
pip3 install /mnt/shared-storage-user/evobox-share/songfan/project/flash_a/flash-attention/flash_attn-2.7.4.post1+cu12torch2.6cxx11abiFALSE-cp310-cp310-linux_x86_64.whl --no-build-isolation
pip3 install -e .
...
conda create -p /mnt/shared-storage-user/evobox-share/songfan/conda_envs/retriever python=3.10 -y
conda activate /mnt/shared-storage-user/evobox-share/songfan/conda_envs/retriever
