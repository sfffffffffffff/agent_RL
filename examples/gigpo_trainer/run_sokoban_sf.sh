...
export WANDB_RUN_ID="gigpo_Qwen3_VL_4B_Instruct_sokoban_v1"
...
#python3 -m examples.data_preprocess.prepare \
    ...
    #--train_data_size 32 \
    #--val_data_size 64 \ 
    #--local_dir /mnt/shared-storage-user/evobox-share/songfan/project/verl-agent-master/data_pre/data_pre_sokoban \
    #
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='gigpo_Qwen3_VL_4B_Instruct_sokoban' \
